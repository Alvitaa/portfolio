    ...
    return (
        <div className="bg-neutral-200 w-1/2 rounded-xl text-center z-1">
            ...
            <div className="p-5">
                ...
                <h3 className="text-2xl font-bold leading-15">{t("fonts")}</h3>
                <p>Inter - <a className="underline" href="https://rsms.me/inter/">Rasmus Andersson</a></p>
                <h3 className="text-2xl font-bold leading-15">{t("images.title")}</h3>
                ...
                <h3 className="text-2xl font-bold leading-15">{t("additional")}</h3>
                <p>React Icons</p>
            </div>
        </div>
    );
