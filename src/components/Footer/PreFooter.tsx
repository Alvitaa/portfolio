        ...
        <div className="w-full cursor-default">
            ...
            <div className="w-full bg-neutral-700 flex flex-row place-content-center p-5 pb-10">
                <div className="bg-neutral-200 font-extrabold text-lg flex items-center gap-2 p-3">
                    ...
                    {t("footer.warning.title").toLocaleUpperCase()}
                </div>
                <div className="bg-red-700 text-white p-2 text-xs max-w-30">
            ...
            <div className="relative bg-[url('/images/gravel.webp')] w-full h-70 bg-cover">
                <div className="absolute w-full h-full inset-0 bg-linear-to-b from-black/30 from-20% via-main/50 via-75% to-main to-95%"></div>
            </div>
        </div>
    );
}
